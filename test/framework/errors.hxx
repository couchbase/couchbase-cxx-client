...
//
// This is the suite's most common assertion by a wide margin -- around 3,000 descendants of
// REQUIRE_SUCCESS -- so what it prints on failure is what most failures look like. It has to name
