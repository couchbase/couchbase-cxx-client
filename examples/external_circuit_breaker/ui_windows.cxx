...
{
  // NO_COLOR is the de-facto opt-out (see no-color.org) — any non-empty value
  // disables ANSI styling. demo::safe_getenv() centralises the _dupenv_s
  // wrapping and empty-value handling shared with ui_unix.cxx.
  return example::demo::safe_getenv("NO_COLOR").has_value();
}
