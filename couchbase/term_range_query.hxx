...
{
/**
 * The term range query finds documents containing a string value in the specified field within the
 ...
 * @snippet{trimleft} unit/management/search.cxx search-term-range
 *
