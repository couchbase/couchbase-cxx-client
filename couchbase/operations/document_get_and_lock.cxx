...
{
std::error_code
get_and_lock_request::encode_to(get_and_lock_request::encoded_request_type& encoded, mcbp_context&& /* context */) const
{
...
get_and_lock_request::make_response(error_context::key_value&& ctx, const encoded_response_type& encoded) const
{
