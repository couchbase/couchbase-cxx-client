...
/**
 * The result for the @ref collection#upsert() operation
 *
 * @since 1.0.0
 * @uncommitted
 */
using upsert_result = mutation_result;
 ...
 * @uncommitted
 */
using upsert_handler = std::function<void(couchbase::key_value_error_context, upsert_result)>;
