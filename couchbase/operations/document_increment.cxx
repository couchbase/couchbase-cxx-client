...
{
std::error_code
increment_request::encode_to(increment_request::encoded_request_type& encoded, mcbp_context&& /* context */) const
{
...
increment_response
increment_request::make_response(error_context::key_value&& ctx, const encoded_response_type& encoded) const
{
