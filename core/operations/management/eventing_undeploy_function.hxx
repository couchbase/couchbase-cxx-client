...
struct eventing_undeploy_function_request {
    using response_type = eventing_undeploy_function_response;
    ...
    [[nodiscard]] eventing_undeploy_function_response make_response(error_context::http&& ctx, const encoded_response_type& encoded) const;
};
} // namespace couchbase::core::operations::management
