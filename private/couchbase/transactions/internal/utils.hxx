...
template<typename T>
T&
wrap_request(T&& req, const transaction_config& config)
{
...
template<typename T>
T&
wrap_durable_request(T&& req, const transaction_config& config)
{
...
template<typename T>
T&
wrap_durable_request(T&& req, const transaction_config& config, durability_level level)
{
    wrap_request(req, config);
