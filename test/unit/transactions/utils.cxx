...
a_core_get_result_converts_to_the_public_one([[maybe_unused]] context& ctx)
{
  ...
  // The content is _moved_ into the public result, so core_result.content() is left in a valid but
  // unspecified state: nothing below may read it, and nothing here asserts what it holds.
}
