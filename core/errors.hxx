...
namespace couchbase::core::error
{
...
{
template<>
struct is_error_code_enum<couchbase::core::error::common_errc> : true_type {
};

template<>
struct is_error_code_enum<couchbase::core::error::key_value_errc> : true_type {
};

template<>
struct is_error_code_enum<couchbase::core::error::query_errc> : true_type {
};

template<>
struct is_error_code_enum<couchbase::core::error::search_errc> : true_type {
};

template<>
struct is_error_code_enum<couchbase::core::error::view_errc> : true_type {
};

template<>
struct is_error_code_enum<couchbase::core::error::analytics_errc> : true_type {
};

template<>
struct is_error_code_enum<couchbase::core::error::management_errc> : true_type {
};

template<>
struct is_error_code_enum<couchbase::core::error::network_errc> : true_type {
};

template<>
struct is_error_code_enum<couchbase::core::error::field_level_encryption_errc> : true_type {
};

template<>
struct is_error_code_enum<couchbase::core::error::streaming_json_lexer_errc> : true_type {
};
} // namespace std
...
make_error_code(couchbase::core::error::common_errc e)
{
    return { static_cast<int>(e), couchbase::core::error::detail::get_common_category() };
}

inline std::error_code
make_error_code(couchbase::core::error::key_value_errc e)
{
    return { static_cast<int>(e), couchbase::core::error::detail::get_key_value_category() };
}

inline std::error_code
make_error_code(couchbase::core::error::query_errc e)
{
    return { static_cast<int>(e), couchbase::core::error::detail::get_query_category() };
}

inline std::error_code
make_error_code(couchbase::core::error::search_errc e)
{
    return { static_cast<int>(e), couchbase::core::error::detail::get_search_category() };
}

inline std::error_code
make_error_code(couchbase::core::error::view_errc e)
{
    return { static_cast<int>(e), couchbase::core::error::detail::get_view_category() };
}

inline std::error_code
make_error_code(couchbase::core::error::analytics_errc e)
{
    return { static_cast<int>(e), couchbase::core::error::detail::get_analytics_category() };
}

inline std::error_code
make_error_code(couchbase::core::error::management_errc e)
{
    return { static_cast<int>(e), couchbase::core::error::detail::get_management_category() };
}

inline std::error_code
make_error_code(couchbase::core::error::network_errc e)
{
    return { static_cast<int>(e), couchbase::core::error::detail::get_network_category() };
}

inline std::error_code
make_error_code(couchbase::core::error::field_level_encryption_errc e)
{
    return { static_cast<int>(e), couchbase::core::error::detail::get_field_level_encryption_category() };
}

inline std::error_code
make_error_code(couchbase::core::error::streaming_json_lexer_errc e)
{
    return { static_cast<int>(e), couchbase::core::error::detail::get_streaming_json_lexer_category() };
}
