...
#undef X
    ...
    JSONSL_SPECIALf_NUMNOINT = (JSONSL_SPECIALf_FLOAT | JSONSL_SPECIALf_EXPONENT | JSONSL_SPECIALf_NAN | JSONSL_SPECIALf_INF)
} jsonsl_special_t;
 ...
 * this action.
 */
typedef void (*jsonsl_stack_callback)(jsonsl_t jsn, jsonsl_action_t action, struct jsonsl_state_st* state, const jsonsl_char_t* at);
 ...
 */
#define jsonsl_util_unescape(in, out, len, toEscape, err) jsonsl_util_unescape_ex(in, out, len, toEscape, NULL, err, NULL)
