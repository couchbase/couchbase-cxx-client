...
bool
protocol::append_response_body::parse(protocol::status status,
...
void
protocol::append_request_body::id(const document_id& id)
{
    key_ = id.key();
...
void
protocol::append_request_body::durability(protocol::durability_level level, std::optional<std::uint16_t> timeout)
{
