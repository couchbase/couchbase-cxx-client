...
add_custom_command(
  ...
  COMMAND
    ...
    -DCPM_USE_LOCAL_PACKAGES=OFF -DCOUCHBASE_CXX_RECORD_BUILD_INFO_FOR_TARBALL=ON
  COMMAND
...
if(COUCHBASE_CXX_CLIENT_RPM_TARGETS)
  ...
  set(COUCHBASE_CXX_CLIENT_RPM "${PROJECT_BINARY_DIR}/packaging/rpm/${COUCHBASE_CXX_CLIENT_RPM_NAME}.el9.x86_64.rpm")
  add_custom_command(
    OUTPUT ${COUCHBASE_CXX_CLIENT_RPM}
    WORKING_DIRECTORY "${PROJECT_BINARY_DIR}/packaging"
    COMMAND ${MOCK} --rebuild --root=${COUCHBASE_CXX_CLIENT_DEFAULT_ROOT}
            --resultdir=${PROJECT_BINARY_DIR}/packaging/rpm "${COUCHBASE_CXX_CLIENT_SRPM}"
    DEPENDS ${COUCHBASE_CXX_CLIENT_SRPM})

  add_custom_target(packaging_rpm DEPENDS ${COUCHBASE_CXX_CLIENT_RPM})
endif()
