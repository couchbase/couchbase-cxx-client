...
// The wire form both the core and the public diagnostics report serialize to.
auto
expected_diagnostics_report() -> tao::json::value
{
  return couchbase::core::utils::json::parse(R"(
{
  "version": 2,
  "id": "0xdeadbeef",
  "sdk": "cxx/1.0.0",
...
// The wire form both the core and the public ping report serialize to.
auto
expected_ping_report() -> tao::json::value
{
  return couchbase::core::utils::json::parse(R"(
{
  "version": 2,
...
void
a_core_diagnostics_report_serializes_to_the_documented_json([[maybe_unused]] context& ctx)
{
  ...
  assert_eq(tao::json::value(res),
            expected_diagnostics_report(),
            "the core diagnostics report on the wire");
}

void
a_public_diagnostics_report_serializes_to_the_documented_json([[maybe_unused]] context& ctx)
{
  ...
  assert_eq(tao::json::from_string(res.as_json()),
            expected_diagnostics_report(),
            "the public diagnostics report on the wire");
}

void
a_core_ping_report_serializes_to_the_documented_json([[maybe_unused]] context& ctx)
{
  ...
  assert_eq(tao::json::value(res), expected_ping_report(), "the core ping report on the wire");
}

void
a_public_ping_report_serializes_to_the_documented_json([[maybe_unused]] context& ctx)
{
  ...
  assert_eq(tao::json::from_string(res.as_json()),
            expected_ping_report(),
            "the public ping report on the wire");
}
} // namespace
...
tests() -> test_suite
{
  return {
    suite_name,
    {
      { CASE(a_core_diagnostics_report_serializes_to_the_documented_json) },
      { CASE(a_public_diagnostics_report_serializes_to_the_documented_json) },
      { CASE(a_core_ping_report_serializes_to_the_documented_json) },
      { CASE(a_public_ping_report_serializes_to_the_documented_json) },
    },
  };
}
