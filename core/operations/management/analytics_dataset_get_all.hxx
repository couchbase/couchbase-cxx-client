...
struct analytics_dataset_get_all_response {
    ...
    std::string status{};
    std::vector<couchbase::core::management::analytics::dataset> datasets{};
...
struct analytics_dataset_get_all_request {
    ...
    [[nodiscard]] analytics_dataset_get_all_response make_response(error_context::http&& ctx, const encoded_response_type& encoded) const;
};
} // namespace couchbase::core::operations::management
