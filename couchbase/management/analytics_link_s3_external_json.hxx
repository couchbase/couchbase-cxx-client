...
{
template<>
struct traits<couchbase::management::analytics::s3_external_link> {
    template<template<typename...> class Traits>
    static couchbase::management::analytics::s3_external_link as(const tao::json::basic_value<Traits>& v)
    {
        couchbase::management::analytics::s3_external_link result{};
