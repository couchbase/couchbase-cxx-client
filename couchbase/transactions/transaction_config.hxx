...
class transaction_config
{
  public:
    ...
    void custom_metadata_collection(const couchbase::transactions::transaction_keyspace& keyspace)
    {
    ...
    [[nodiscard]] std::optional<couchbase::transactions::transaction_keyspace> custom_metadata_collection() const
    {
