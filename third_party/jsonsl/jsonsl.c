...
#define IS_NORMAL_NUMBER ((state)->special_flags == JSONSL_SPECIALf_UNSIGNED || (state)->special_flags == JSONSL_SPECIALf_SIGNED)
...
jsonsl__match_continue(jsonsl_jpr_t jpr, const struct jsonsl_jpr_component_st* component, unsigned prlevel, unsigned chtype)
{
...
JSONSL_API
jsonsl_jpr_match_t
jsonsl_path_match(jsonsl_jpr_t jpr, const struct jsonsl_state_st* parent, const struct jsonsl_state_st* child, const char* key, size_t nkey)
{
...
JSONSL_API
jsonsl_jpr_t
jsonsl_jpr_match_state(jsonsl_t jsn, struct jsonsl_state_st* state, const char* key, size_t nkey, jsonsl_jpr_match_t* out)
{
