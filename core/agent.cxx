...
class agent_impl
{
  public:
    ...
    auto get(get_options /* options */, get_callback&& /* callback */) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
    {
        return { {}, errc::common::unsupported_operation };
    }

    auto get_and_touch(get_and_touch_options /* options */, get_and_touch_callback&& /* callback */)
      -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
    {
        return { {}, errc::common::unsupported_operation };
    }
    ...
    auto get_collection_id(std::string scope_name,
                           ...
                           get_collection_id_callback callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
    {
    ...
    auto wait_until_ready(std::chrono::milliseconds /* timeout */,
                          ...
                          wait_until_ready_callback&& /* callback */) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
    {
        return { {}, errc::common::unsupported_operation };
    }

    auto ping(ping_options /* options */, ping_callback&& /* callback */) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
    {
        return { {}, errc::common::unsupported_operation };
    }

    auto diagnostics(diagnostics_options /* options */) -> std::pair<diagnostic_info, std::error_code>
    {
        return { {}, errc::common::unsupported_operation };
    }
    ...
    auto range_scan_continue(std::vector<std::byte> scan_uuid,
                             ...
                             range_scan_continue_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
    {
    ...
    auto range_scan_cancel(std::vector<std::byte> scan_uuid,
                           ...
                           range_scan_cancel_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
    {
...
auto
agent::get(get_options options, get_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
{
...
auto
agent::touch(touch_options options, touch_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
{
    return impl_->touch(std::move(options), std::move(callback));
}

auto
agent::unlock(unlock_options options, unlock_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
{
    return impl_->unlock(std::move(options), std::move(callback));
}

auto
agent::remove(remove_options options, remove_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
{
    return impl_->remove(std::move(options), std::move(callback));
}

auto
agent::insert(insert_options options, insert_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
{
    return impl_->insert(std::move(options), std::move(callback));
}

auto
agent::upsert(upsert_options options, upsert_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
{
    return impl_->upsert(std::move(options), std::move(callback));
}

auto
agent::replace(replace_options options, replace_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
{
    return impl_->replace(std::move(options), std::move(callback));
}

auto
agent::append(adjoin_options options, adjoin_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
{
    return impl_->append(std::move(options), std::move(callback));
}

auto
agent::prepend(adjoin_options options, adjoin_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
{
    return impl_->prepend(std::move(options), std::move(callback));
}

auto
agent::increment(counter_options options, counter_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
{
    return impl_->increment(std::move(options), std::move(callback));
}

auto
agent::decrement(counter_options options, counter_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
{
...
auto
agent::ping(ping_options options, ping_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
{
    return impl_->ping(std::move(options), std::move(callback));
}

auto
agent::diagnostics(diagnostics_options options) -> std::pair<diagnostic_info, std::error_code>
{
    return impl_->diagnostics(options);
}

auto
agent::stats(stats_options options, stats_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
{
...
auto
agent::observe(observe_options options, observe_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
{
...
auto
agent::lookup_in(lookup_in_options options, lookup_in_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
{
    return impl_->lookup_in(std::move(options), std::move(callback));
}

auto
agent::mutate_in(mutate_in_options options, mutate_in_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
{
...
agent::range_scan_cancel(std::vector<std::byte> scan_uuid,
                         std::uint16_t vbucket_id,
                         range_scan_cancel_options options,
                         range_scan_cancel_callback&& callback) const -> std::pair<std::shared_ptr<pending_operation>, std::error_code>
{
