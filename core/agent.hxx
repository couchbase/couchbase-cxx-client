...
class agent
{
  public:
    ...
    auto touch(touch_options options, touch_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>;

    auto unlock(unlock_options options, unlock_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>;

    auto remove(remove_options options, remove_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>;

    auto insert(insert_options options, insert_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>;

    auto upsert(upsert_options options, upsert_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>;

    auto replace(replace_options options, replace_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>;

    auto append(adjoin_options options, adjoin_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>;

    auto prepend(adjoin_options options, adjoin_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>;

    auto increment(counter_options options, counter_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>;

    auto decrement(counter_options options, counter_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>;
    ...
    auto observe(observe_options options, observe_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>;
    ...
    auto stats(stats_options options, stats_callback&& callback) -> std::pair<std::shared_ptr<pending_operation>, std::error_code>;
