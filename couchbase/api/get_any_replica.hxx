...
{
/**
 * Opaque structure representing get_any_replica request.
 *
...
/**
 * Creates operation to retrieve a document for a given id, leveraging both the active and all available replicas. This method follows the
 * same semantics of @ref make_get_all_replicas_request, but returns the first response as opposed to returning all responses.
 *
 * @param id the document identifier
 * @param options operation customization
 * @return couchbase::impl::get_any_replica_request
 *
