...
{
bool
upsert_response_body::parse(api::key_value_status_code status,
...
void
upsert_request_body::id(const document_id& id)
{
    key_ = make_protocol_key(id);
}

void
upsert_request_body::durability(protocol::durability_level level, std::optional<std::uint16_t> timeout)
{
...
void
upsert_request_body::fill_extras()
{
