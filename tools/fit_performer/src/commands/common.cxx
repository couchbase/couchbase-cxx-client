...
{
  // Compose the duration from typed chrono units instead of manually scaling seconds by 1e9 (a
  // floating-point literal) and adding nanos in a single int64_t, which is easy to get wrong and
  // can overflow during the intermediate multiplication for large timestamps.
  const auto duration =
