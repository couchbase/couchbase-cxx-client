 ...
 * @committed
 */
struct append_options : public common_durability_options<append_options> {
    /**
     ...
     * @internal
     */
    struct built : public common_durability_options<append_options>::built {
     ...
     * @return the {@link append_options} for chaining purposes.
     */
