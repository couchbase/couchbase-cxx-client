...
// what tells it the session is there -- and the state it reports is what distinguishes a session
// parked idle from one that failed and closed itself. report() fires either way.
