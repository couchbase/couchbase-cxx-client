...
// Must be defined before any spdlog header is included (directly or transitively) to take effect.
...
main(int argc, const char* argv[])
{
  ...
  if (const auto* log_level_env = std::getenv("LOG_LEVEL"); log_level_env != nullptr) {
    ...
    std::transform(level_env.begin(), level_env.end(), level_env.begin(), [](unsigned char c) {
