...
struct eventing_get_status_response {
    ...
    couchbase::core::management::eventing::status status{};
    std::optional<eventing_problem> error{};
};

struct eventing_get_status_request {
    using response_type = eventing_get_status_response;
    ...
    [[nodiscard]] eventing_get_status_response make_response(error_context::http&& ctx, const encoded_response_type& encoded) const;
};
} // namespace couchbase::core::operations::management
