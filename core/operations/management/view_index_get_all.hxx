...
struct view_index_get_all_response {
    ...
    std::vector<couchbase::core::management::views::design_document> design_documents{};
};
...
struct view_index_get_all_request {
    ...
    [[nodiscard]] view_index_get_all_response make_response(error_context::http&& ctx, const encoded_response_type& encoded) const;
};
} // namespace couchbase::core::operations::management
