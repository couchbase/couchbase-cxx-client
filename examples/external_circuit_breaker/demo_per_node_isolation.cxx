  ...
  -> void
{
  ...
  for (int i = 0; i < total_keys; ++i) {
    ...
    // unresolved rather than letting an empty id fall through to allow(),
    // which would count it as "allowed to proceed" and hide the routing
    // gap. This matches the guard used in demo_topology_sweep.cxx.
    if (e || !target) {
      ++unresolved;
      continue;
    }
