...
{
template<>
struct traits<couchbase::operations::management::analytics_link::azure_blob_external> {
    template<template<typename...> class Traits>
    static couchbase::operations::management::analytics_link::azure_blob_external as(const tao::json::basic_value<Traits>& v)
    {
        couchbase::operations::management::analytics_link::azure_blob_external result{};
