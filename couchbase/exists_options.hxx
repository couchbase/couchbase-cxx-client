...
/**
 * Options for @ref collection#exists().
 *
 * @since 1.0.0
 * @committed
 */
struct exists_options : public common_options<exists_options> {
    /**
     ...
     * @internal
     */
    struct built : public common_options<exists_options>::built {
    };
...
/**
 * The signature for the handler of the @ref collection#exists() operation
 *
 * @since 1.0.0
 * @uncommitted
 */
