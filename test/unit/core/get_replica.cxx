...
void
an_empty_chain_is_out_of_bounds([[maybe_unused]] context& ctx)
{
  // A row that covers the vbucket but names nobody, active included.
  ...
  return {
    suite_name,
    {
      ...
      { CASE(wrap_advances_past_a_replica_on_a_node_the_topology_does_not_list),
        {},
        timeout::instant },
      { CASE(an_empty_chain_is_out_of_bounds), {}, timeout::instant },
