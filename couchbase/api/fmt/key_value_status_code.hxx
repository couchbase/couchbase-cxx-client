...
template<>
struct fmt::formatter<couchbase::api::key_value_status_code> {
    ...
    auto format(couchbase::api::key_value_status_code opcode, FormatContext& ctx) const
    {
        using couchbase::api::key_value_status_code;
