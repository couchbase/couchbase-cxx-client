...
{
bool
prepend_response_body::parse(api::key_value_status_code status,
...
void
prepend_request_body::durability(protocol::durability_level level, std::optional<std::uint16_t> timeout)
{
