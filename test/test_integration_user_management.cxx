...
TEST_CASE("integration: user groups management", "[integration]")
{
    ...
    SECTION("group crud")
    {
...

        {
            ...
            auto resp = test::utils::retry_on_error(integration.cluster, req, couchbase::error::management_errc::group_not_found);
            REQUIRE_FALSE(resp.ctx.ec);
    ...
    SECTION("user and groups crud")
    {
...

        {
            ...
            req.user = user;
            auto resp = test::utils::retry_on_error(integration.cluster, req, couchbase::error::common_errc::invalid_argument);
            REQUIRE_FALSE(resp.ctx.ec);
        }
...

        {
            ...
            auto resp = test::utils::retry_on_error(integration.cluster, req, couchbase::error::management_errc::user_not_found);
            REQUIRE_FALSE(resp.ctx.ec);
